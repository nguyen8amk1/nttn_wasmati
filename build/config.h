#ifndef WASMATI_CONFIG_H_
#define WASMATI_CONFIG_H_

#include <stdint.h>
#include <stdlib.h>

/* #undef WASMATI_VERSION_INFO */
...
#define WABT_PRINTF_FORMAT(format_arg, first_arg) __attribute__((format(gnu_printf, (format_arg), (first_arg))))
#else
...
#else
#define WABT_STATIC_ASSERT__(x, c) static int static_assert_##c[(x ? 0 : -1)] WABT_UNUSED
...
inline int Popcount(unsigned long value) { return __popcnt(value); }
